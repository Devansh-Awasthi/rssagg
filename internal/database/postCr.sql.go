...
select posts.id, posts.created_at, posts.updated_at, posts.title, posts.description, posts.published_at, posts.url, posts.feed_id from posts join feeds_following on posts.feed_id=feeds_following.feed_id 
